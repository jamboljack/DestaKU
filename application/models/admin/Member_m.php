...
{
    public $table         = 'v_member';
    public $column_order  = array(null, null, 'user_username', 'user_name', 'nama_kec', 'nama_kel', 'user_email', 'user_level', null);
    public $column_search = array('user_username', 'user_name', 'nama_kec', 'nama_kel', 'user_email', 'user_level', 'user_status');
    ...
    public function insert_data()
    {
        $data = array(
            ...
            'no_kec'           => trim(stripHTMLtags($this->input->post('lstKecamatan', 'true'))),
            'no_kel'           => trim(stripHTMLtags($this->input->post('lstDesa', 'true'))),
            'user_phone'       => trim(stripHTMLtags($this->input->post('no_hp', 'true'))),
            'user_level'       => 'Member',
            'user_status'      => 'Aktif',
            'user_date_create' => date('Y-m-d'),
