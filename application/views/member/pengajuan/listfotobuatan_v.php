        ...
        <div class="kt-container kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="#" class="kt-subheader__breadcrumbs-link">
                        Daftar Foto Wisata Buatan : <?=$detail->pengajuan_wisata_buatan_nama;?>
                    </a>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    var pengajuan_wisata_buatan_id = '<?=$detail->pengajuan_wisata_buatan_id;?>';
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('member/pengajuan/data_wisata_buatan_foto_list/');?>"+pengajuan_wisata_buatan_id,
            "type": "POST"
        },
        "columnDefs": [
            {
...
function hapusData(pengajuan_wisata_buatan_foto_id) {
    var id = pengajuan_wisata_buatan_foto_id;
    swal.fire({
        title: 'Anda Yakin ?',
        ...
        if (result.value) {
            $.ajax({
                url : "<?=site_url('member/pengajuan/deletedatafotobuatan')?>/"+id,
                type: "POST",
...
$(document).ready(function() {
    $( "#formInput" ).validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '<?=site_url('member/pengajuan/savedatafotobuatan');?>',
                type: "POST",
                dataType: 'json',
                data: formData,
                async: true,
...
<div class="modal fade" id="formModalAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="pengajuan_wisata_buatan_id" value="<?=$detail->pengajuan_wisata_buatan_id;?>">
