        ...
        <div class="kt-container kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="#" class="kt-subheader__breadcrumbs-link">
                        Form Edit Pengajuan : <?=$detail->pengajuan_no_pendaftaran;?>
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item">
                                            <a href="<?=site_url('member/pengajuan/printprofil/'.$detail->pengajuan_id);?>" class="kt-nav__link" target="_blank">
                                                <i class="kt-nav__link-icon flaticon-profile-1"></i>
                                                <span class="kt-nav__link-text"> Profil Wilayah</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="<?=site_url('member/pengajuan/printpengelola/'.$detail->pengajuan_id);?>" class="kt-nav__link" target="_blank">
                                                <i class="kt-nav__link-icon flaticon-list-1"></i>
                                                <span class="kt-nav__link-text"> Wisatawan dan Pengelola</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="<?=site_url('member/pengajuan/printpotensiwisata/'.$detail->pengajuan_id);?>" class="kt-nav__link" target="_blank">
                                                <i class="kt-nav__link-icon flaticon-placeholder-1"></i>
                                                <span class="kt-nav__link-text"> Potensi Wisata</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="<?=site_url('member/pengajuan/printrtrw/'.$detail->pengajuan_id);?>" class="kt-nav__link" target="_blank">
                                                <i class="kt-nav__link-icon flaticon-app"></i>
                                                <span class="kt-nav__link-text"> Kesesuaian RTRW</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="<?=site_url('member/pengajuan/printmitigasi/'.$detail->pengajuan_id);?>" class="kt-nav__link" target="_blank">
