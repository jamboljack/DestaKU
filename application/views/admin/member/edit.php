                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="lstKecamatan" id="lstKecamatan" onchange="tampilDesa()">
                                                ...
                                                <option value="<?=$r->no_kec;?>" <?=($detail->no_kec==$r->no_kec?'selected':'');?>><?=$r->nama_kec;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="no_hp" id="no_hp" autocomplete="off" placeholder="Input No. WA" value="<?=$detail->user_phone;?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
function tampilDesaEdit() {
    no_prov = '33';
    no_kab  = '19';
    no_kec  = '<?=$detail->no_kec;?>';
    no_kel  = '<?=$detail->no_kel;?>';
    $.ajax({
        url:"<?=site_url('admin/member/select_desa_edit/');?>"+no_kel+"/"+no_kec+"/"+no_kab+"/"+no_prov,
        success: function(response) {
            $("#lstDesa").html(response);
        },
        dataType:"html"
...
$(document).ready(function() {
    $( "#formInput" ).validate({
        rules: {
            ...
            no_hp: { required: true, minlength: 12, number: true },
        ...
        messages: {
            ...
            no_hp: { required:'No. WA required', minlength:'Minimal 12 Digit', number:'Hanya Angka' },
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "<?=site_url('admin/member/updatedata');?>",
                type: "POST",
                data: dataString,
