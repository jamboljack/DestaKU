            ...
            <div class="kt-portlet__head kt-portlet__head--sm">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        Daftar RTRW : <?=$detail->rtrw_grup_nama;?>
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-actions">
                        <a href="<?=site_url('admin/rtrw');?>" class="btn btn-clean"><i class="la la-arrow-left"></i><span class="kt-hidden-mobile">Kembali</span></a>
...
$(document).ready(function() {
    var rtrw_grup_id = '<?=$detail->rtrw_grup_id;?>';
    table = $('#tableData').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?=site_url('admin/rtrw/data_detail_list/');?>"+rtrw_grup_id,
            "type": "POST"
        },
        "columnDefs": [
            {
...
function hapusData(rtrw_detail_id) {
    var id = rtrw_detail_id;
    swal.fire({
        title: 'Anda Yakin ?',
        ...
        if (result.value) {
            $.ajax({
                url : "<?=site_url('admin/rtrw/deletedatadetail')?>/"+id,
                type: "POST",
...
$(document).ready(function() {
    $( "#formInput" ).validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/rtrw/savedatadetail');?>',
                type: "POST",
                data: dataString,
                success: function(data) {
                    swal.fire({
...
function edit_data(id) {
    $('#formEdit')[0].reset();
    $.ajax({
        url : "<?=site_url('admin/rtrw/get_data_detail/');?>"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('#id').val(data.rtrw_detail_id);
            $('#rtrw_detail_nama').val(data.rtrw_detail_nama);
...
$(document).ready(function() {
    $( "#formEdit" ).validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '<?=site_url('admin/rtrw/updatedatadetail');?>',
                type: "POST",
                data: dataString,
                success: function(data) {
                    swal.fire({
...
<div class="modal fade" id="formModalAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="rtrw_grup_id" value="<?=$detail->rtrw_grup_id;?>">
        ...
        <div class="modal-content">
            ...
            <input type="hidden" name="id" id="id">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input type="text" class="form-control" placeholder="Input Keterangan" name="nama" id="rtrw_detail_nama" autocomplete="off">
                    </div>
                </div>
                <div class="modal-footer">
